...
/**
 * Created by Yalan Ding on 2020/3/22.
 */
/*
 ...
 */
class IgnoreMultipartHttpLoggingInterceptor @JvmOverloads constructor(
        ...
        if (logHeaders) {
            ...
            if (!logBody || requestBody == null) {
                ...
                if (buffer.isProbablyUtf8()) {
                    if (!ignoreList.contains(request.url.encodedPath)) {
    ...
    private var ignoreList = emptyList<String>()
    fun ignoreList(list: List<String>) {
        ignoreList = list
    }
}
